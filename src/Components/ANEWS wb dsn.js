    ...
    <div className="ANEWS-wrapper">
      ...
      <header className="ANEWS-header">
        ...
        <nav className="ANEWS-nav">
          ...
          <a href="https://www.youtube.com/@A_NEWS_/shorts"  target='_blank'rel="noreferrer">News</a>
          <a href="https://www.youtube.com/@A_NEWS_/playlists" target='_blank'rel="noreferrer">Sports</a>
          ...
          <a href="https://www.instagram.com/follow.anews?utm_source=ig_web_button_share_sheet&igsh=MXc4Z2UxdjhnNm91dQ=="target='_blank'rel="noreferrer" >Instagram</a>
        </nav>
